...
verification are built and tested (963 tests) — proven on real bugs,
...
and tested (963 tests), proven on real bugs. Live participation still needs the full
...
are — 963 tests, proven on real bugs (including a real ARVO bug solved
