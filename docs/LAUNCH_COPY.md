...
verification are built and tested (764 tests) — proven on real bugs,
...
and tested (764 tests), proven on real bugs. Live participation still needs the full
...
are — 764 tests, proven on real bugs (including a real ARVO bug solved
